...
<script setup>
import infoCard1 from './infoCardComponent1.vue'
import alertCard from './alertCardComponent.vue'
import table1 from './tableComponent1.vue'
import table2 from './tableComponent2.vue'
